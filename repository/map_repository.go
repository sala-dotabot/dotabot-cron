...
type SubscriptionRepository interface {
	...
	SaveLastKnownMatchId(subscription TelegramMatchSubscription, matchId uint64)
	FindAll() []TelegramMatchSubscription
}
...
func (this MapRespository) FindAll() []TelegramMatchSubscription {
...
func (this MapRespository) SaveLastKnownMatchId(subscription TelegramMatchSubscription, matchId uint64) {
